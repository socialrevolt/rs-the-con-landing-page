<section class="section section--party" id="<?php echo $id_9; ?>">
        ...
        <div class="party__wrap party__wrap--layout-right">
          ...
          <div class="party__row party__row--bottom flex flex--nowrap">
            ...
            <div class="row---bottom__left">
              <div class="party__row__image" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/dist/img/pool-party-1.jpg);"></div>
