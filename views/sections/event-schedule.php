        ...
        <div class="section__column">
          ...
          <div class="section__image">
            <div class="section__image__wrap loading">
              <img class="lazyload" data-src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/pool-party-1.jpg" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" />
            </div>
          </div>
        </div>
