<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
  <div class="header__top">
    <div class="outer-container">
      ...
      <meta itemprop="description" content="the Conference is an annual, by-invitation event for high-performance global influencers and brands">
      <meta itemprop="keywords" content="the Conference, rewardStyle">
      <img itemprop="logo" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/rewardStyle_Logo_BLACK.svg" width="130" height="30" alt="rewardStyle logo">
    </div>
  </div>
