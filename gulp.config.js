...
module.exports = {
	...
	// Project options.
	projectURL: 'rewardstyle.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
  ...
  // JS Output options.
	jsDestination: './dist/js/', // Path to place the compiled JS custom scripts file.
	jsFile: 'script', // Compiled JS custom file name. Default set to custom i.e. custom.js.
  ...
  watchScripts: './assets/js/**/*.js', // Path to all custom JS files.
	watchPhp: './**/*.php', // Path to all PHP files.

	// Translation options.
	textDomain: 'rewardstyle', // Your textdomain here.
	translationFile: 'REWARDSTYLE.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'REWARDSTYLE', // Package name.
